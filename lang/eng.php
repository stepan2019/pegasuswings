...
/*
	...
	* version 9
	* (c) 2018 OxyClassifieds.com (office@oxyclassifieds.com).
	*
*/
...
$lng['navbar']['contactmail'] = 'You can fill out the contact form or mail to mazadxane@gmail.com';
$lng['navbar']['contactfooter'] = 'Contact Mail: mazadxane@gmail.com';
...
// ------------------ NEW AD -------------------
$lng['listings']['listing'] = 'Property Code';
...
$lng['listings']['enter_photos'] = 'Click on the camera to upload the photos';
$lng['listings']['ad_information'] = 'Ad Information';
$lng['listings']['free'] = 'FREE';
$lng['listings']['details'] = 'Details';
$lng['listings']['stock_no'] = 'Property No';
...
$lng['listings']['id'] = 'Search by ads Number';
...
$lng['useraccount']['total_views'] = 'Total Hits';
...
$lng['contact']['webpage'] = 'Webpage with http://';
...
$lng['general']['all'] = 'All';
$lng['general']['notification']='Notification';
$lng['general']['Featurde_Property']='Featured Properties';
// -------------------------- REGISTER -----------------------
$lng['users']['store'] = 'Agency Page';
$lng['users']['store_banner'] = 'Logo of Agency or your Photo';
...
// ------------------ NEW AD -------------------
$lng['listings']['report_ad'] = 'Report Ad';
...
$lng['listings']['ad_details'] = 'Property Details';
...
$lng['listings']['video_code'] = 'Video link on Youtube';
...
$lng['listings']['extraphoto'] = ' Click on the camera to select the photos ';
...
$lng['alerts']['email_alert_info'] = 'Receive email alerts when new listings show up for this search.';
...
$lng['listings']['list'] = 'List view';
$lng['listings']['gallery'] = 'Photos view';
...
$lng['users']['store_info'] = 'Agency information';
$lng['users']['user_listings'] = 'All Properties';
...
// --------------- end  8.5 --------------------
// ------------------- begin responcible ------------------
$lng['general']['responsible'] = 'We are not responsible for the content of advertising';
// ------------------- end responcible ------------------
// ---------------  8.7 --------------------
...
// ---------------  8.7 --------------------
// ------------------- Latest Dealers ------------------ 
$lng['general']['latest_dealers'] = 'Latest Dealers'; 
// ------------------- Latest Dealers ------------------ 
$lng['history_ads']['title'] = 'Your recent history';
//--------------------------history ---------------
// ---------------  8.10 --------------------
...
$lng['quick_search']['location'] = ' Place';
...
$lng['listings']['ad_details_more'] = 'Property More Details';
// --------------- 9.2 --------------------
