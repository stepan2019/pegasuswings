<?php /* Smarty version 3.1.24, created on 2019-09-10 15:29:01
         compiled from "/home/pegasuswings/public_html/admin/templates/default/affiliates_revenues.html" */ ?>
<?php
/*%%SmartyHeaderCode:16181754205d77c13d746e75_00411029%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2de0c9c131d281942617b3dc60f55c2c98a2709f' => 
    array (
      0 => '/home/pegasuswings/public_html/admin/templates/default/affiliates_revenues.html',
      1 => 1531209280,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16181754205d77c13d746e75_00411029',
  'variables' => 
  array (
    'lng' => 0,
    'no_per_page' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_5d77c13d7ddf43_93516307',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5d77c13d7ddf43_93516307')) {
function content_5d77c13d7ddf43_93516307 ($_smarty_tpl) {
if (!is_callable('smarty_modifier_replace')) require_once '/home/pegasuswings/public_html/libs/plugins/modifier.replace.php';

$_smarty_tpl->properties['nocache_hash'] = '16181754205d77c13d746e75_00411029';
...
<div class="page_title">
 ...
 > <?php echo $_smarty_tpl->tpl_vars['lng']->value['affiliates']['revenues'];?>
</div>

	<div class="rfloat mt5">

	<div class="buttonwrapper lfloat mr10"><div class="tab1-left">
	<a href="affiliates_revenues.php"><span class="tab1-right"><?php echo $_smarty_tpl->tpl_vars['lng']->value['affiliates']['revenues'];?>
</span></a>
	</div></div>

	<div class="buttonwrapper lfloat mr10"><div class="tab2-left">
	<a href="affiliates_payments.php"><span class="tab2-right"><?php echo $_smarty_tpl->tpl_vars['lng']->value['affiliates']['payments_history'];?>
</span></a>
	</div></div>
...
<div class="p30">
<form name="search" id="search" method="post" action="affiliates_revenues.php?no_per_page=<?php echo $_smarty_tpl->tpl_vars['no_per_page']->value;
if (isset($_smarty_tpl->tpl_vars['page']->value)) {?>&page=<?php echo $_smarty_tpl->tpl_vars['page']->value;
}?>">
...
<tr id="theading">
	...
	<th><?php echo $_smarty_tpl->tpl_vars['lng']->value['listings']['id'];?>
</th>
...
<?php
$_from = $_smarty_tpl->tpl_vars['revenue_array']->value;
...
?>
<tr class="<?php if (!isset($_smarty_tpl->tpl_vars['v']->value['completed']) || !$_smarty_tpl->tpl_vars['v']->value['completed']) {?> inactive<?php }?>">
	<td><input type="checkbox" class="noborder" name="rev<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" id="rev<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
"></td>
	<td>#<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
</td>
	<td><a href="affiliates_revenues.php?affiliate_id=<?php echo $_smarty_tpl->tpl_vars['v']->value['affiliate_id'];?>
...
echo $_smarty_tpl->tpl_vars['v']->value['username'];
	...
	<td>
		<div><?php if ($_smarty_tpl->tpl_vars['v']->value['released']) {?><div class="small-btn activebutton icon"><?php echo $_smarty_tpl->tpl_vars['lng']->value['affiliates']['released'];?>
</div><?php } else { ?><div class="small-btn inactivebutton icon"><?php echo $_smarty_tpl->tpl_vars['lng']->value['affiliates']['not_released'];?>
</div><?php }
if ($_smarty_tpl->tpl_vars['v']->value['paid']) {?><div class="small-btn orangebutton"><?php echo $_smarty_tpl->tpl_vars['lng']->value['affiliates']['paid'];?>
</div><?php } else { ?><div class="small-btn inactivebutton"><?php echo $_smarty_tpl->tpl_vars['lng']->value['affiliates']['not_paid'];?>
</div><?php }?></div>
	</td>
	<td class="laligned"><?php echo $_smarty_tpl->tpl_vars['v']->value['action_str'];?>
</td>
	<td>
		<span><a href="javascript:;" class="ordinfo" id="ord<?php echo $_smarty_tpl->tpl_vars['v']->value['order_id'];?>
">
		<img src="<?php echo $_smarty_tpl->tpl_vars['template_path']->value;?>
...
" alt="">
		...
		<span><a href="javascript:;" onclick="onDelete('<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
...
<?php if ($_smarty_tpl->tpl_vars['no_rev']->value == 0) {?>
...
<?php if ($_smarty_tpl->tpl_vars['no_rev']->value) {?><div class="rfloat mt20"><?php echo $_smarty_tpl->getSubTemplate ("paginator.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0);
?>
</div><?php }?>
