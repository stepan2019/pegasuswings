...
//***
	...
	case 'listing':
		...
		//Image
		if ( isset($listing['images'][0]['picture']) ){
			$listing['pic_thumb']	= '<img class="pic-thumb" src="'. $config_live_site .'/images/listings/'. $listing['images'][0]['folder'] .'/medThmb/'. $listing['images'][0]['picture'] .'" />';
		}
		else {
			$listing['pic_thumb']	= '';
		}
